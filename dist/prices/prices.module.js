...
exports.PricesModule = PricesModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([price_history_entity_1.PriceHistory])],
        providers: [price_service_1.PricesService],
        exports: [price_service_1.PricesService, typeorm_1.TypeOrmModule.forFeature([price_history_entity_1.PriceHistory])], // Export repository
    })
], PricesModule);
